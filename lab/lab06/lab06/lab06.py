...
class BankAccount():
    ...
    def deposit(self, amount):
        ...
        transaction=Transaction(self.id,before,self.balance)
        self.id+=1
    ...
    def withdraw(self, amount):
        ...
        transaction=Transaction(self.id,self.balance,after)
        self.transactions.append(transaction)
        self.id+=1
        self.balance = self.balance - amount
        return self.balance
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        year=Mint.present_year-self.year-50
        if year>=0:
            return year+self.cents
        else:
            return self.cents
